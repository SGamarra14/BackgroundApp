...
public class AgregarSerie extends AppCompatActivity {
    ...
    private void EliminarImagenAnterior() {
        ...
        Imagen.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(AgregarSerie.this, "La imagen anterior ha sido eliminada", Toast.LENGTH_SHORT).show();
                SubirNuevaImagen();
            }
    ...
    private void ActualizarImagenBD(final String NuevaImagen) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //startActivity(new Intent(AgregarSerie.this, SeriesA.class)); crea doble pantalla de cat SeriesA
                finish();
            }
    ...
    private void SubirImagen() {
        ...
        if (mNombre.equals("") || RutaArchivoUri == null) {
            ...
            progressDialog.setMessage("Subiendo la imagen SERIE...");
            progressDialog.show();
            progressDialog.show();
            progressDialog.setCancelable(false);
